        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TermAcademicYear = table.Column<int>(type: "INTEGER", nullable: false),
                    TermTermName = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ScheduleDayOfWeek = table.Column<int>(type: "INTEGER", nullable: true),
                    ScheduleStartTime = table.Column<TimeSpan>(type: "TEXT", nullable: true),
                    ScheduleEndTime = table.Column<TimeSpan>(type: "TEXT", nullable: true),
                    ScheduleLocation = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    EnrollmentOpensAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    EnrollmentClosesAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "AcademicCourseMemberships",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicCourseMemberships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AcademicCourseMemberships_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AcademicCourseMemberships_AcademicCourseOfferings_CourseOfferingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicCourseDefinitions_TenantId_Name",
                table: "AcademicCourseDefinitions",
                columns: new[] { "TenantId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_AcademicCourseMemberships_CourseOfferingId",
                table: "AcademicCourseMemberships",
                column: "CourseOfferingId");

            migrationBuilder.CreateIndex(
                name: "IX_AcademicCourseMemberships_TenantId_CourseOfferingId_Status",
                table: "AcademicCourseMemberships",
                columns: new[] { "TenantId", "CourseOfferingId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_AcademicCourseMemberships_TenantId_CourseOfferingId_UserId",
                table: "AcademicCourseMemberships",
                columns: new[] { "TenantId", "CourseOfferingId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AcademicCourseMemberships_UserId",
                table: "AcademicCourseMemberships",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicCourseOfferings_TenantId_CourseDefinitionId",
                table: "AcademicCourseOfferings",
                columns: new[] { "TenantId", "CourseDefinitionId" });
