...
namespace ZYC.VerbClass.EntityFrameworkCore.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AcademicCourseDefinitions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicCourseDefinitions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicTimeTemplates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    CanAssignUsers = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "AcademicCourseOfferings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                    AcademicTermId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CourseDefinitionId = table.Column<Guid>(type: "TEXT", nullable: false),
                    OfferingCode = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    CourseCodeSnapshot = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    CourseNameSnapshot = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    ExtraProperties = table.Column<string>(type: "TEXT", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatorId = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicCourseOfferings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AcademicCourseOfferings_AcademicCourseDefinitions_CourseDefinitionId",
                        column: x => x.CourseDefinitionId,
                        principalTable: "AcademicCourseDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AcademicCourseOfferings_AcademicTerms_AcademicTermId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicTermPeriods", x => new { x.AcademicTermId, x.PeriodNo });
                    table.ForeignKey(
                        name: "FK_AcademicTermPeriods_AcademicTerms_AcademicTermId",
                        column: x => x.AcademicTermId,
                        principalTable: "AcademicTerms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "AcademicTimeTemplatePeriods",
                columns: table => new
                {
                    PeriodNo = table.Column<int>(type: "INTEGER", nullable: false),
                    AcademicTimeTemplateId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Label = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    StartTime = table.Column<TimeOnly>(type: "TEXT", nullable: false),
                    EndTime = table.Column<TimeOnly>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicTimeTemplatePeriods", x => new { x.AcademicTimeTemplateId, x.PeriodNo });
                    table.ForeignKey(
                        name: "FK_AcademicTimeTemplatePeriods_AcademicTimeTemplates_AcademicTimeTemplateId",
                        column: x => x.AcademicTimeTemplateId,
                        principalTable: "AcademicTimeTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "AppDepartmentAssignments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppDepartmentAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppDepartmentAssignments_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppDepartmentAssignments_AppDepartments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    SurnameKanji = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    NameKanji = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    SurnameKana = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    NameKana = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    SurnameRomanized = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    NameRomanized = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    BirthDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Gender = table.Column<int>(type: "INTEGER", nullable: true),
                    BloodType = table.Column<string>(type: "TEXT", maxLength: 16, nullable: true),
                    ...
                    Prefecture = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppUserProfiles_AppFiles_AvatarFileId",
            ...
            migrationBuilder.CreateTable(
                name: "AcademicCourseOfferingParticipants",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CourseOfferingId = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicCourseOfferingParticipants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AcademicCourseOfferingParticipants_AcademicCourseOfferings_CourseOfferingId",
                        column: x => x.CourseOfferingId,
                        principalTable: "AcademicCourseOfferings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "AcademicCourseOfferingScheduleSlots",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicCourseOfferingScheduleSlots", x => new { x.CourseOfferingId, x.Weekday, x.PeriodNo });
                    table.ForeignKey(
                        name: "FK_AcademicCourseOfferingScheduleSlots_AcademicCourseOfferings_CourseOfferingId",
                        column: x => x.CourseOfferingId,
                        principalTable: "AcademicCourseOfferings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicCourseDefinitions_TenantId_Code",
                table: "AcademicCourseDefinitions",
                columns: new[] { "TenantId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AcademicCourseOfferingParticipants_CourseOfferingId",
                table: "AcademicCourseOfferingParticipants",
                column: "CourseOfferingId");

            migrationBuilder.CreateIndex(
                name: "IX_AcademicCourseOfferingParticipants_TenantId_CourseOfferingId_UserId",
                table: "AcademicCourseOfferingParticipants",
                columns: new[] { "TenantId", "CourseOfferingId", "UserId" },
                unique: true,
                filter: "\"IsDeleted\" = 0");

            migrationBuilder.CreateIndex(
                name: "IX_AcademicCourseOfferings_AcademicTermId",
                table: "AcademicCourseOfferings",
                column: "AcademicTermId");

            migrationBuilder.CreateIndex(
                name: "IX_AcademicCourseOfferings_CourseDefinitionId",
                table: "AcademicCourseOfferings",
                column: "CourseDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_AcademicCourseOfferings_TenantId_AcademicTermId_OfferingCode",
                table: "AcademicCourseOfferings",
                columns: new[] { "TenantId", "AcademicTermId", "OfferingCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AcademicTerms_TenantId_AcademicYear_Code",
                table: "AcademicTerms",
                columns: new[] { "TenantId", "AcademicYear", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AcademicTimeTemplates_TenantId_Code",
                table: "AcademicTimeTemplates",
                columns: new[] { "TenantId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppDepartmentAssignments_DepartmentId",
                table: "AppDepartmentAssignments",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AppDepartmentAssignments_TenantId_DepartmentId",
                table: "AppDepartmentAssignments",
                columns: new[] { "TenantId", "DepartmentId" });

            migrationBuilder.CreateIndex(
                name: "IX_AppDepartmentAssignments_TenantId_UserId",
                table: "AppDepartmentAssignments",
                columns: new[] { "TenantId", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_AppDepartmentAssignments_TenantId_UserId_DepartmentId_EffectiveFrom",
                table: "AppDepartmentAssignments",
                columns: new[] { "TenantId", "UserId", "DepartmentId", "EffectiveFrom" });

            migrationBuilder.CreateIndex(
                name: "IX_AppDepartmentAssignments_UserId",
                table: "AppDepartmentAssignments",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppDepartments_TenantId_Code",
                table: "AppDepartments",
                columns: new[] { "TenantId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppDepartments_TenantId_ParentDepartmentId",
                table: "AppDepartments",
                columns: new[] { "TenantId", "ParentDepartmentId" });

            migrationBuilder.CreateIndex(
                name: "IX_AppDepartments_TenantId_Path",
                table: "AppDepartments",
                columns: new[] { "TenantId", "Path" });

            migrationBuilder.CreateIndex(
                name: "IX_AppFiles_TenantId_BlobName",
                table: "AppFiles",
                columns: new[] { "TenantId", "BlobName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppUserProfiles_AvatarFileId",
                table: "AppUserProfiles",
                column: "AvatarFileId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserProfiles_TenantId_UserId",
                table: "AppUserProfiles",
                columns: new[] { "TenantId", "UserId" },
                unique: true);
