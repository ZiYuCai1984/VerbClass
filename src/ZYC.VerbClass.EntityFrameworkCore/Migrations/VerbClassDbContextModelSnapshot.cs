...
{
    [DbContext(typeof(VerbClassDbContext))]
    partial class VerbClassDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZYC.VerbClass.Domain.DepartmentAssignments.DepartmentAssignment", b =>
                {
                    ...
                    b.HasIndex("TenantId", "UserId", "DepartmentId", "EffectiveFrom");

                    b.ToTable("AppDepartmentAssignments", (string)null);
                });

            modelBuilder.Entity("ZYC.VerbClass.Domain.Departments.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ZYC.VerbClass.Domain.UserProfiles.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ZYC.VerbClass.Domain.DepartmentAssignments.DepartmentAssignment", b =>
                {
                    b.HasOne("ZYC.VerbClass.Domain.Departments.Department", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ZYC.VerbClass.Domain.UserProfiles.UserProfile", b =>
                {
                    b.HasOne("ZYC.VerbClass.Domain.AppFiles.AppFile", null)
                        .WithMany()
                        .HasForeignKey("AvatarFileId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.OwnsOne("ZYC.VerbClass.Domain.UserProfiles.AddressInfo", "AddressInfo", b1 =>
                        {
                    ...
                    b.OwnsOne("ZYC.VerbClass.Domain.UserProfiles.PersonNameInfo", "NameInfo", b1 =>
                        {
                            b1.Property<Guid>("UserProfileId")
                                .HasColumnType("TEXT");

                            b1.Property<string>("NameKana")
                                .HasMaxLength(64)
                                .HasColumnType("TEXT")
                                .HasColumnName("NameKana");

                            b1.Property<string>("NameKanji")
                                .HasMaxLength(64)
                                .HasColumnType("TEXT")
                                .HasColumnName("NameKanji");

                            b1.Property<string>("NameRomanized")
                                .HasMaxLength(64)
                                .HasColumnType("TEXT")
                                .HasColumnName("NameRomanized");

                            b1.Property<string>("SurnameKana")
                                .HasMaxLength(64)
                                .HasColumnType("TEXT")
                                .HasColumnName("SurnameKana");

                            b1.Property<string>("SurnameKanji")
                                .HasMaxLength(64)
                                .HasColumnType("TEXT")
                                .HasColumnName("SurnameKanji");

                            b1.Property<string>("SurnameRomanized")
                                .HasMaxLength(64)
                                .HasColumnType("TEXT")
                                .HasColumnName("SurnameRomanized");
